    ...
    <div class="section-body">
      ...
      <div class="card">
        <div class="card-header">
          <h4>Data Penjualan Listrik</h4>
          <div class="card-header-action"><a href="/up3/tambahkwh" class="btn btn-primary">Tambah Baru <i class="fas fa-chevron-right"></i></a></div>
        </div>
        <div class="card-body">
            ...
            <table class="table table-striped" id="table-1">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    <td><a href="#"><?= $i++; ?></a></td>
                    <td class="font-weight-600"><?= date('F', strtotime($p['bulan'])); ?></td>
                    <td>
                    ...
                    <td class="justify-content-between">
                      <a href="/up3/editkwh/<?= $p['kategori_id']; ?>" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                      <a href="/up3/deletekwh/<?php echo $p['kategori_id']; ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda Yakin?')"><i class="fa fa-eraser"></i></a>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
          ...
          <table class="table table-striped">
            ...
            ?>
              <tr>
                ...
                <td><?= $p['total_tarif_s']; ?></td>
                <td><?= $p['total_tarif_r']; ?></td>
                <td><?= $p['total_tarif_b']; ?></td>
                <td><?= $p['total_tarif_i']; ?></td>
                <td><?= $p['total_tarif_p']; ?></td>
              </tr>
            <?php endforeach; ?>
          </table>
        </div>
