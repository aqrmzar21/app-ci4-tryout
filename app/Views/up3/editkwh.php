    ...
    <div class="section-body">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          foreach ($kwhUP3 as $p) :
          ?>
            <form method="post" action="/up3/updatekwh/<?= $p['kategori_id']; ?>">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <select class="form-control" name="klasifikasi_id" id="">
                    <option value="5" <?= $p['jenis_klasifikasi'] == 'Pra Bayar' ? 'selected' : ''; ?>>Pra Bayar</option>
                    <option value="6" <?= $p['jenis_klasifikasi'] == 'Pasca Bayar' ? 'selected' : ''; ?>>Pasca Bayar</option>
                  </select>
                </div>
              </div>
              <div class="form-group row">
