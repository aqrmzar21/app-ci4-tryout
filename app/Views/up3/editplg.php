  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="#">Data Jumlah Pelanggan</a></div>
    ...
    <div class="section-body">
      ...
      <div class="card">
        <div class="card-header text-center">
          <a href="/up3/dataplg" class="mr-4"><i class="fa fa-arrow-left"></i></a>
        ...
        <div class="card-body">
          ...
          foreach ($plgUP3 as $p) :
          ?>
            <form method="post" action="/up3/updateplg/<?= $p['kategori_id']; ?>">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <select class="form-control" name="klasifikasi_id" id="">
                    <option value="1" <?= $p['jenis_klasifikasi'] == 'Pra Bayar' ? 'selected' : ''; ?>>Pra Bayar</option>
                    <option value="2" <?= $p['jenis_klasifikasi'] == 'Pasca Bayar' ? 'selected' : ''; ?>>Pasca Bayar</option>
                  </select>
                </div>
              </div>
              <div class="form-group row">
