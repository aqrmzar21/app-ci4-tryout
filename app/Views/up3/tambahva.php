  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        <div class="breadcrumb-item active"><a href="#">VA</a></div>
    ...
    <div class="section-body">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form method="post" action="/up3/saveva">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-6">
                <select class="form-control" name="klasifikasi_id" id="">
                  <?php
                  $vaUP3_unique = [];
                  foreach ($vaUP3 as $key) {
                    $vaUP3_unique[$key['klasifikasi_id']] = $key['jenis_klasifikasi'];
                  }

                  foreach ($vaUP3_unique as $klasifikasi_id => $jenis_klasifikasi) {
